...
function DiscoverPanel() {
  return (
    <div className="zopa">
      {ZOPA_ISSUES.map(z => {
        const statusLabel = z.status === "zopa" ? "Overlap · ready" : z.status === "conv" ? "Convergent" : "Gap";
  ...
  return (
    <div>
      ...
      <div className="framework">
        ...
        <p>The marital residence located at <span className="var">[ADDRESS · redacted]</span> shall be sold within <span className="var">180</span> days of execution. Net proceeds shall be divided <span className="var">52 / 48</span> in favor of Party A, reflecting the equitable-distribution band identified in the gap analysis.</p>
